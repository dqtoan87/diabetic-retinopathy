...
vis_img.load_dataset("train_DR_m2/")

train_maskrcnn = instance_custom_training()
train_maskrcnn.modelConfig(network_backbone = "resnet101", num_classes= 2, batch_size = 4)
train_maskrcnn.load_pretrained_model("mask_rcnn_coco.h5")
train_maskrcnn.load_dataset("train_DR_m2/")
train_maskrcnn.train_model(num_epochs = 500, augmentation=True,  path_trained_models = "mask_rcnn_models_2/")
print("Finish!")
...
segment_image.inferConfig(num_classes= 2, class_names= ["BG", "AN", "NV"])
segment_image.load_model("mask_rcnn_models_2/mask_rcnn_model500.h5")
...
cv2.imwrite("Test_DR/output_2.png", output)
# print("=== MASKS ====")
# print(segmask['masks'])
# print("=== ROIS ====")
# print(segmask['rois'])
